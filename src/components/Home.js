...
const Home=()=> {
    return ( 
        <div className="mt-[150px] flex justify-around min-h-[600px] lg:flex-col-reverse lg:mx-[25%] lg:mt-20 lg:mb-8">
            <div className="mt-16 lg:flex lg:flex-col lg:items-center ">
